...
if(@$_GET['fdid'] && $_SESSION['key']=='arya9901360273') {
$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='arya9901360273') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='arya9901360273') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='arya9901360273') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='arya9901360273') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='arya9901360273')
{
